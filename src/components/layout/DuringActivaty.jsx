...
import { duringExercise } from "@/constant";
import duringProgram from "../../assets/during_program.png";


const DuringActivaty = () => {
  return (
    <div className="container mx-auto px-3 space-y-10">
      <div>
        ...
        >
          {duringExercise.map((course, index) => (
